                ...
                <div class="col-md-9">
                    ...
                    <form class="my-3" onsubmit="return false;" role="search">
                        <div class="d-flex mb-3">
                            ...
                            <select id="select-gugun" class="form-select me-2">
                    ...
                    <div class="modal-body">
                        <form action="">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="question" class="form-label">여행제목:</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="question"
                            ...
                            <div class="mb-3">
                                ...
                                <label for="question" class="form-label">세부일정:</label>
                                <button
                                    type="button"
                                    id="btn-answer-add"
